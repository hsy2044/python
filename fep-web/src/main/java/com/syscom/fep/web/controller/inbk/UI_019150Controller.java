...
import com.syscom.fep.web.form.inbk.UI_019150_Form;
 ...
 */
@Controller
public class UI_019150Controller extends BaseController {
    @Autowired
    ...
    public void pageOnLoad(ModelMap mode) {
        // 初始化表單資料
        UI_019150_Form form = new UI_019150_Form();
        // 交易日期
        form.setDatetime(FormatUtil.dateTimeFormat(Calendar.getInstance(), FormatUtil.FORMAT_DATE_YYYY_MM_DD_2));
        WebUtil.putInAttribute(mode, AttributeName.Form, form);
    }
    @PostMapping(value = "/inbk/UI_019150/getINBKPendList")
    public String getINBKPendList(@ModelAttribute UI_019150_Form form, ModelMap mode) {
        ...
        try {
            ...
            PageData<UI_019150_Form, Inbkpend> pageData = new PageData<>(pageInfo, form);
        ...
        return Router.UI_019150.getView();
    }
}
